...
export const AVAILABLE_PROPERTIES = {
  "type": "dual purpose, a category for the geometry but will also be used as an SVG<br/> if matching the name of available icons and no icon key is used|required",
  "name": "geometry name|required",
  "icon": "the name of the SVG displayed, must match the name of <a href='https://github.com/CodaBool/stargazer.vercel.app/wiki/Sci%E2%80%90Fi-maps-for-all#icon' style='color: rgb(133, 163, 255);'>available icons</a>",
  "unofficial": "shows a tag marking the geometry as unofficial",
  "crowded": "used to determine if a label should be shown above the geometry<br/>Warning, this will eventually be changed to 'label'",
  "description": "markdown text which describes the geometry",
  "faction": "the faction this geometry aligns with, typically used with territories to change the color",
  "capital": "shows a tag marking the geometry as a capital",
  "city": "comma separated list of cities present at the location",
  "destroyed": "shows a tag marking the geometry as destroyed",
  "alias": "comma separated list of alternative names",
}
