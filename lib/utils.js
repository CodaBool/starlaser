...
export const AVAILABLE_PROPERTIES = {
  ...
  "icon": "a remote SVG URL (<a href='https://gist.githubusercontent.com/CodaBool/8c4ae1b4cc000c1b96d4f881175adbdd/raw/ea260e9614b4c91dcff4b6511f5b53793dd043ec/farmer.svg' target='_blank' style='color: rgb(133, 163, 255);'>i.e.</a>). This takes priority over the type key.<br/><b>All icon colors must be defined on the remote resource</b>.<br/>Meaning, location fill values are ignored when an icon is present.|type=text",
  ...
  "crowded": "used to determine if a label should be shown above the geometry<br/>Warning, this will eventually be changed to 'label'|type=true/false",
  ...
  "city": "comma separated list of cities present at the location|type=comma text",
  "alias": "comma separated list of alternative names|type=comma text",
  "fill": "interior color for Territories polygons. Also works as the line color for Locations. Guides do use fill.<br/>Use <a href='https://rgbacolorpicker.com' target='_blank' style='color: rgb(133, 163, 255);'>rgbacolorpicker.com</a> to select a color|type=rgba",
  "stroke": "line color for Territories and Guides. Locations do not use stroke.<br/>Use <a href='https://rgbacolorpicker.com' target='_blank' style='color: rgb(133, 163, 255);'>rgbacolorpicker.com</a> to select a color|type=rgba",
}
...
export function combineAndDownload(type, serverTopojson, clientGeojson) {
  ...
  try {
    ...
    const serverGeojsonLocation = feature(serverTopojson, serverTopojson.objects["location"]);
    const serverGeojsonTerritory = feature(serverTopojson, serverTopojson.objects["territory"]);
