...
export const accent = {
  "lancer": "rgb(61,150,98)",
  "fallout": "rgb(255,215,120)",
}
...
export const accentSoft = {
  "lancer": "rgba(61,150,98,.4)",
  "fallout": "rgba(255,215,120,.4)",
}
  ...
  if (map === "fallout") {
    if (style === "stroke") {
      if (geo === "Point") {
        ...
        if (type === "settlement") return "rgb(29 19 38)"
        ...
        if (type === "compound") return "rgb(20 3 15)"
        return "rgb(96 0 48)"
        ...
        if (faction === "Ceasar's Legion") return "rgba(245, 81, 39, 0.1)"
        if (faction === "NCR") return "rgba(133, 92, 0,.2)"
      ...
      if (geo === "Point") {
        ...
        if (type === "territory") return "rgb(39, 39, 40)"
        return "rgba(142, 232, 237, .05)"
      }
    }
  } else if (map === "lancer") {
    if (style === "stroke") {
      ...
      // if (name === "The Long Rim") return "rgba(255, 255, 255, 0.2)";
