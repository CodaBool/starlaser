...
export const AVAILABLE_PROPERTIES = {
  "type": "dual purpose, a category for the geometry but will also be used as an SVG<br/> if matching the name of <a style='color: rgb(133, 163, 255);' target='_blank' href='https://github.com/CodaBool/stargazer.vercel.app/wiki/Sci%E2%80%90Fi-maps-for-all#icon'>available icons</a> and no icon key is used|required|type=text",
  "name": "geometry name|required|type=text",
  "icon": "the name of the SVG displayed, must match the name of <a href='https://github.com/CodaBool/stargazer.vercel.app/wiki/Sci%E2%80%90Fi-maps-for-all#icon' target='_blank' style='color: rgb(133, 163, 255);'>available icons</a>|type=text",
...
export async function combineAndDownload(type, serverTopojson, clientGeojson) {
