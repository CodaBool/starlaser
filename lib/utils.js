  ...
  if (map === "fallout") {
    if (style === "stroke") {
      ...
      if (geo === "Point") {
        ...
        // territory
        if (faction === "Brotherhood of Steel") return "blue"
        if (faction === "Ceasar's Legion") return "red"
        if (faction === "NCR") return "#ffd755"
        if (destroyed) return "black"
        if (type === "region") return "rgb(142 232 237)"
        if (type === "faction") return "rgb(142 232 237)"
        return "rgb(39 39 40)"
      }
    }
  } else if (map === "lancer") {
